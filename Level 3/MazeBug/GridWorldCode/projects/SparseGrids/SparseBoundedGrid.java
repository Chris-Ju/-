...
public class SparseBoundedGrid<E> extends AbstractGrid<E> {
     ...
     * Precondition: <code>rowNum > 0</code> and <code>colNum > 0</code>.
     *
    ...
    public E put(Location loc, E obj) {
        ...
        // Add the object to the grid. we put the new occupant to the front of a row list.
    ...
    public E remove(Location loc) {
        ...
        if (locNode != null) {
            ...
            if (preNode != null) {
                ...
                // the preNode is null indicates that the locNode is the Head of the row.
                // the head changes!
     ...
     * getNode by loction
     * @param loc given location
     * @return target Node if empty return null
     */
    ...
    /**
     * get object by given node
     * @param node given node
     * @return occupant if null return null
     */
